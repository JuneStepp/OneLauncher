...
class Ui_winMain(object):
    def setupUi(self, winMain):
        ...
        self.chkSaveAccount = QCheckBox(self.centralwidget)
        self.chkSaveAccount.setObjectName(u"chkSaveAccount")
        self.chkSaveAccount.setGeometry(QRect(530, 172, 260, 29))
        self.chkSaveAccount.setFont(font)
...
#if QT_CONFIG(tooltip)
        self.chkSaveAccount.setToolTip(QCoreApplication.translate("winMain", u"<html><head/><body><p>Save last used world and account name</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
